...
Operaciones::comprobar_derechos('form_add_tienda');
    ...
    $(document).ready(function() {
        ...
        $("#guardar").click(function() {
            ...
            if (nombre.length == 0){
                ...
                alert('Debe validar la dirección en el mapa o especificar las coordenadas (latitud y longitud).')
                return false;
...
<div class="holder">
    ...
    <table style="border: 1px solid #D3D3D3;width: 98%;margin: 10px;padding: 20px">
        <tr>
            <td colspan="2" style="text-align: center;font-weight: bold;font-size: 1.3em;padding-bottom: 30px"><span class="titulo_formulario">Formulario de alta de tienda</span></td>
        </tr>
        <tr>
            <td class="etiqueta_campo">Nombre <span class="color_campo_obligatorio">*</span></td>
            <td><input id="nombre" name="nombre" type="text" style="width:275px"></td>
        </tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input id="direccion" type="text" name="direccion" style="width:275px"/> &nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="etiqueta_campo">C&oacute;digo Postal <span class="color_campo_obligatorio">*</span></td>
                                        <td>
                                            <input id="cp" type="text" name="cp" style="width:50px"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="etiqueta_campo">Ciudad <span class="color_campo_obligatorio">*</span></td>
                                        <td>
                                            <input id="ciudad" type="text" name="ciudad" style="width:200px"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="zona" type="text" name="zona" style="width:200px"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="etiqueta_campo">Latitud</td>
                                            <td>
                                                <input id="latitud" type="text" name="latitud" style="width:200px"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="etiqueta_campo">Longitud</td>
                                            <td>
                                                <input id="longitud" type="text" name="longitud" style="width:200px"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align: center;height:100px">
                                                <span id="msg_cargando" style="display: none" >
                                                    <img src="gfx/images/ajax-loader2.gif" style="margin-top: 4px"/>
                                                </span>
                                                <br/>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <fieldset style="width: 225px">
                                                                        ...
                                                                        <ul id="horario" class="lista_sin_formato"></ul>
                                                                    </fieldset>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <fieldset style="width: 225px">
                                                                            ...
                                                                            <ul id="listado_servicios" class="lista_sin_formato"></ul>
                                                                        </fieldset>
                                                                    </td>
                                                                </tr>
